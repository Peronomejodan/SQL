...
VALUES
		(@GOSSIP_MENU_ENTRY+150, @GOSSIP_MENU_OPTION+0, @GOSSIP_MENU_ICON, 'Armes d\'hast', @GOSSIP_MENU_TYPE, @GOSSIP_MENU_FLAGS, @GOSSIP_MENU_ENTRYID+151, ''),
			...
			(@GOSSIP_MENU_ENTRY+151, @GOSSIP_MENU_OPTION+1, @GOSSIP_MENU_ICON, @RECETTE37, @GOSSIP_MENU_TYPE, @GOSSIP_MENU_FLAGS, @GOSSIP_MENU_ENTRYID+151, @RECETTE37_0),
				(@GOSSIP_MENU_ENTRY+151, @GOSSIP_MENU_OPTION+2, @GOSSIP_MENU_ICON, @RECETTE37_1, @GOSSIP_MENU_TYPE, @GOSSIP_MENU_FLAGS, @GOSSIP_MENU_ENTRYID+151, @RECETTE_NA),

			(@GOSSIP_MENU_ENTRY+151, @GOSSIP_MENU_OPTION+3, @GOSSIP_MENU_ICON, @RECETTE37, @GOSSIP_MENU_TYPE, @GOSSIP_MENU_FLAGS, @GOSSIP_MENU_ENTRYID+151, @RECETTE37_0),
				(@GOSSIP_MENU_ENTRY+151, @GOSSIP_MENU_OPTION+4, @GOSSIP_MENU_ICON, @RECETTE37_1, @GOSSIP_MENU_TYPE, @GOSSIP_MENU_FLAGS, @GOSSIP_MENU_ENTRYID+151, @RECETTE_NA),

			(@GOSSIP_MENU_ENTRY+151, @GOSSIP_MENU_OPTION+4, @GOSSIP_MENU_ICON, @RECETTE37, @GOSSIP_MENU_TYPE, @GOSSIP_MENU_FLAGS, @GOSSIP_MENU_ENTRYID+151, @RECETTE37_0),
				(@GOSSIP_MENU_ENTRY+151, @GOSSIP_MENU_OPTION+5, @GOSSIP_MENU_ICON, @RECETTE37_1, @GOSSIP_MENU_TYPE, @GOSSIP_MENU_FLAGS, @GOSSIP_MENU_ENTRYID+151, @RECETTE_NA);
		-- -- -- --
		#
		#- ARMES D'HAST FIN
		#
