...
VALUES
	(@GOSSIP_MENU_ENTRY, @GOSSIP_MENU_OPTION, @GOSSIP_MENU_ICON, 'Amélioration d\'objet', @GOSSIP_MENU_TYPE, @GOSSIP_MENU_FLAGS, @GOSSIP_MENU_ENTRYID+50, ''),
		(@GOSSIP_MENU_ENTRY+50, @GOSSIP_MENU_OPTION, @GOSSIP_MENU_ICON, @RECETTE1, @GOSSIP_MENU_TYPE, @GOSSIP_MENU_FLAGS, @GOSSIP_MENU_ENTRYID+1, @RECETTE1_0),
		...
		(@GOSSIP_MENU_ENTRY+50, @GOSSIP_MENU_OPTION+6, @GOSSIP_MENU_ICON, @RECETTE7, @GOSSIP_MENU_TYPE, @GOSSIP_MENU_FLAGS, @GOSSIP_MENU_ENTRYID+50, @RECETTE7_0),
		(@GOSSIP_MENU_ENTRY+50, @GOSSIP_MENU_OPTION+7, @GOSSIP_MENU_ICON, @RECETTE8, @GOSSIP_MENU_TYPE, @GOSSIP_MENU_FLAGS, @GOSSIP_MENU_ENTRYID+50, @RECETTE8_0),
		(@GOSSIP_MENU_ENTRY+50, @GOSSIP_MENU_OPTION+8, @GOSSIP_MENU_ICON, @RECETTE9, @GOSSIP_MENU_TYPE, @GOSSIP_MENU_FLAGS, @GOSSIP_MENU_ENTRYID+50, @RECETTE9_0),
		(@GOSSIP_MENU_ENTRY+50, @GOSSIP_MENU_OPTION+9, @GOSSIP_MENU_ICON, @RECETTE10, @GOSSIP_MENU_TYPE, @GOSSIP_MENU_FLAGS, @GOSSIP_MENU_ENTRYID+50, @RECETTE10_0),
		(@GOSSIP_MENU_ENTRY+50, @GOSSIP_MENU_OPTION+10, @GOSSIP_MENU_ICON, @RECETTE11, @GOSSIP_MENU_TYPE, @GOSSIP_MENU_FLAGS, @GOSSIP_MENU_ENTRYID+50, @RECETTE11_0),
		(@GOSSIP_MENU_ENTRY+50, @GOSSIP_MENU_OPTION+11, @GOSSIP_MENU_ICON, @RECETTE12, @GOSSIP_MENU_TYPE, @GOSSIP_MENU_FLAGS, @GOSSIP_MENU_ENTRYID+50, @RECETTE12_0),
		(@GOSSIP_MENU_ENTRY+50, @GOSSIP_MENU_OPTION+12, @GOSSIP_MENU_ICON, @RECETTE13, @GOSSIP_MENU_TYPE, @GOSSIP_MENU_FLAGS, @GOSSIP_MENU_ENTRYID+50, @RECETTE13_0),
